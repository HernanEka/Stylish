			...
			<div class="row justify-content-center">
				<div class="col-md-5">
					<div class="card text-center">
						...
						<div class="card-img-overlay">
							<div class="card-body">
								<a href="fashion.php" class="btn white-box">TOKO WANITA <span class="fa fa-chevron-right"></span></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-5">
					<div class="card text-center">
						...
						<div class="card-img-overlay">
							<div class="card-body">
								<a href="#" class="btn white-box">TOKO PRIA <span class="fa fa-chevron-right"></span></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-5">
					<div class="card text-center">
						...
						<div class="card-img-overlay">
							<div class="card-body">
								<a href="#" class="btn white-box">TOKO OLAHRAGA <span class="fa fa-chevron-right"></span></a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-5">
					<div class="card text-center">
						...
						<div class="card-img-overlay">
							<div class="card-body">
								<a href="#" class="btn white-box">TOKO ANAK <span class="fa fa-chevron-right"></span></a>
							</div>
						</div>
					</div>
				</div>
