				...
				<div class="p-4">
					<?php if ($kategori == 'user') { ?>
						...
						<form action="" method="POST" class="col-md-5">
							...
							<hr>
							<button type="submit" class="btn btn-primary" name="user">Tambah Data +</button>
						</form>
					<?php }elseif ($kategori == 'product') {?>
						<h1 class="display-6">Tambah Data Product</h1>
						<form action="" method="POST" enctype="multipart/form-data" class="col-md-5">
							...
							<div class="my-3">
								...
								<input type="number" id="harga" name="harga" class="form-control" placeholder="Harga Product">
							</div>
							<div class="my-3">
							...
							<hr>
							<button type="submit" class="btn btn-primary" name="product">Tambah Data +</button>
						</form>
					<?php } ?>
				</div>
			</div>
